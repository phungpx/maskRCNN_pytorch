...
from models.based_maskrcnn.mask_rcnn import (
    MaskRCNN,
    RPNHead,
    MaskRCNNHeads,
...
class MaskRCNNResNet50FPNV2(nn.Module):
    def __init__(
        self,
        ...
        **kwargs: Any,
        ...
        super(MaskRCNNResNet50FPNV2, self).__init__()
        weights = (
            MaskRCNN_ResNet50_FPN_V2_Weights.verify(
