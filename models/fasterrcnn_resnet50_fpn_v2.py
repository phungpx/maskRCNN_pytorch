...
from models.based_maskrcnn.backbones.resnet import ResNet50_Weights, resnet50
...
class FasterRCNNResNet50FPNV2(nn.Module):
    def __init__(
        ...
        **kwargs: Any,
        ...
        weights = (
            FasterRCNN_ResNet50_FPN_V2_Weights.verify(
        ...
        weights_backbone = (
            ResNet50_Weights.verify(ResNet50_Weights.IMAGENET1K_V1)
