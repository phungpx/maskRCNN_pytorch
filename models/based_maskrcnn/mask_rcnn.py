...
def maskrcnn_resnet50_fpn(
    ...
    **kwargs: Any,
    ...
    Example::
        >>> model = torchvision.models.detectionmodels.based_maskrcnn_resnet50_fpn(weights=MaskRCNN_ResNet50_FPN_Weights.DEFAULT)
        >>> model.eval()
        >>> x = [torch.rand(3, 300, 400), torch.rand(3, 500, 400)]
        >>> predictions = model(x)
        >>>
...
def maskrcnn_resnet50_fpn_v2(
    ...
    **kwargs: Any,
    ...
    :func:`~torchvision.models.detectionmodels.based_maskrcnn_resnet50_fpn` for more details.
    Args:
